...
### Task2: 摄像头寻黑线，找到垂直、水平的两根线，试着用摄像头测定`它自己`与`线`的距离; 另一个人用程序测算`从起点 到 色块 之间的距离`（假设速度恒定）
...
### Task3: 利用OpenMV测算`第2根杆 与 第一根杆 的夹角度数`
...
### Task4: 让无人机飞起来，先手动遥控，后编程控制。要求能不使用GPS，用超声波定高。最后还得让无人机缓慢地降落
